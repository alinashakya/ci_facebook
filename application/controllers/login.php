...
class Login extends CI_Controller {
    ...
    public function index() {
        if (isset($_GET['code']) AND ! empty($_GET['code'])) {
            ...
            parse_str($this->get_fb_contents("https://graph.facebook.com/oauth/access_token?client_id=1700284973592773&redirect_uri=" . urlencode(base_url('login')) . "&client_secret=2bfb05554e3eebee07b463248495ba48&code=" . urlencode($code)));
